...
<div class="row">
  <div class="col-sm-12">
      ...
      @if ($loop->first)
      <h2>Order : {{$customerData2->companyname}}</h2> <br>
              ...
              <tr>
                ...
                <td>
                    ...
                    <!-- dynamic input ------------------->
                      ...
                      <span id="cancel{{$reservedData->r_id}}" class="orderbtns">{{$reservedData->reserved_quantity}}<br>Cancel Edit</span>
...
<div class="row">
  <div class="col-sm-6">
    <div class="well well-sm" style="background-color:white">
      ...
      <a href="/supplier/offline" class="btn btn-success">Ofline Payments</a>
    </div>
  </div>
