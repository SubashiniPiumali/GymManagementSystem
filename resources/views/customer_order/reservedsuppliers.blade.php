...
@if(Session::has('success'))
 ...
 @endif
    ...
    <center><img class="img-responsive" style="max-height: 20vh;" src="data:image;base64,{{$display->image}}" alt="image"></center>
     ...
     <form action="/viewreservedonesupplier/{{$customer->supplier_Id}}" method="POST" class="form-container" >
      {{csrf_field()}}
     ...
     <div class="col-sm-3">
              ...
              <br>
                 ...
                 <input type="hidden" name="supid" class="form-control" value="{{$customer->supplier_Id}}" />
